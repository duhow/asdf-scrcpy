...
# TODO: Ensure this is the correct GitHub homepage where releases can be downloaded for scrcpy.
GH_REPO="https://github.com/Genymobile/scrcpy"
TOOL_NAME="scrcpy"
TOOL_TEST="scrcpy --version"
...
# NOTE: You might want to remove this if scrcpy is not hosted on GitHub releases.
...
install_version() {
	...
	(
		...
		# TODO: Assert scrcpy executable exists.
		local tool_cmd
